...
export default function CreatingStore() {
  ...
  const [storeId, setStoreId] = useState(""); // Store ID (for adding categories)
  ...
  const handleCreateStore = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setStoreId(data.storeId); // Assuming the response contains storeId
        router.push("/Profile");
      } else {
